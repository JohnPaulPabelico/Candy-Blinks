        ...
        <div className="mt-10 flex items-center justify-center gap-10">
          <div className="p-5 bg-neutral-800 rounded-lg shadow-lg shadow-pink-900/50 max-w-[440px] border-pink-900 border-2">
            ...
            <div className="mt-3">
              ...
              <div className="text-sm dm-sans text-neutral-400 text-wrap w-full">
                CandyBlinks is a powerful no-code platform that empowers you to
                create and deploy multiple Metaplex&apos;s Candy Machine powered
                Blinks in just a few clicks. No coding required, just pure
                creativity!
              </div>
          ...
          <div>
            ...
            <div className="mt-5 bg-neutral-900 border-pink-950 border-2 p-5 text-white rounded-xl ">
              ...
              <div className="mt-4 text-xl font-bold">Multiply Your Magic</div>
              <div className="w-80 text-md text-neutral-400">
                Launch multiple Blinks simultaneously with ease, saving you time
                and expanding your reach instantly.
              </div>
            </div>
            <div className="mt-5 bg-neutral-900 border-pink-950 border-2 p-5 text-white rounded-xl ">
              <div>
              ...
              <div className="mt-4 text-xl font-bold">One Click to Launch</div>
              <div className="w-80 text-md text-neutral-400">
                Share your custom Candy Blink to any Blink supported websites
                and deploy it instantly! It&apos;s as simple as share and shine!
              </div>
            </div>
          </div>
        </div>
